...
return[
  // For checkins that went as expected
	'success.title' => 'Checkin successful',
	'success.message' => 'You are now checked in. In ten seconds this screen will reset to the home page.',
