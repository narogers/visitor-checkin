<?php include("header.php"); ?>
    <div role="main" class="ui-content formContent">
        ...
        <div>
            ...
            <div>
                <div>
                    ...
                    <p class="red">Museum Archives Use Policies</p>
                    ...
                    <p class="red">Online Databases</p>
                    ...
                    <p class="red">Ingalls Library Image Database Restrictions</p>
            ...
            <blockquote class="strong">It is your responsibility to observe the legal use of copyrighted data or information. Abuse of these regulations and policies will result in immediate withdrawal of all ID and password access privileges, loss of library privileges and will be reported to the academic authorities or other appropriate authority. Visitors to the Ingalls Library and Museum Archives agree to indemnify and hold harmless the Cleveland Museum of Art, its officers, trustees and employees, from and against all claims or actions arising out of or related to such visitor’s (a) use of library or archived items; and (b) violation of this use agreement or any of the rules or procedures of the Ingalls Library or Museum Archives.</blockquote>
        </div>
        ...
        <div class="ui-grid-a">
            ...
            <div class="ui-block-b" style="text-align:right"><button data-inline="true" data-theme="b" onclick="processForm();" data-icon="arrow-r" data-iconpos="right">I Agree</button> then please [RESET]</div>
        </div>
    </div>
